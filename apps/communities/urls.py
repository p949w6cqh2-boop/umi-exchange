...
from apps.dashboard.views import DashboardView, DashboardCSVExportView
...
urlpatterns = [
    ...
    path("<slug:slug>/dashboard/export/", DashboardCSVExportView.as_view(), name="dashboard-export"),
    # Needs
