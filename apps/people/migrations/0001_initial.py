    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "created_in_community",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.PROTECT, related_name="persons", to="communities.community"
                    ),
                ),
                (
                    "household",
        ...
        migrations.AddIndex(
            model_name="person",
            index=models.Index(fields=["created_in_community"], name="people_person_comm_idx"),
        ),
        migrations.AddIndex(
            model_name="person",
            index=models.Index(fields=["household"], name="people_person_hh_idx"),
        ),
    ]
