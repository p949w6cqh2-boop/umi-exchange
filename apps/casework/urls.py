...
urlpatterns = [
    ...
    path("followups/<uuid:pk>/status/", views.FollowUpStatusView.as_view(),
    ...
    path("<uuid:pk>/handoffs/<uuid:handoff_id>/ack/",
         views.HandoffAckView.as_view(), name="handoff-ack"),
    ...
    path("<uuid:pk>/notes/<uuid:note_id>/finalize/",
         views.NoteFinalizeView.as_view(), name="note-finalize"),
    path("<uuid:pk>/notes/<uuid:note_id>/amend/",
         views.NoteAmendView.as_view(), name="note-amend"),
    path("<uuid:pk>/notes/<uuid:note_id>/discard/",
         views.NoteDiscardView.as_view(), name="note-discard"),

    path("<uuid:pk>/followups/new/", views.FollowUpCreateView.as_view(),
         name="followup-create"),
    path("<uuid:pk>/grants/new/", views.GrantCreateView.as_view(), name="grant-create"),
    path("<uuid:pk>/grants/<uuid:grant_id>/revoke/",
         views.GrantRevokeView.as_view(), name="grant-revoke"),
]
