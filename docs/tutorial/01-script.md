...
| 4 | Post an ask (form) | 32–45 | Asking takes about a minute. Pick a category, say it in a line or two. A ride to Mass, math help for your kid, a hand with the groceries. And there's a promise printed right where you type: nothing about you is shared until you accept a match. | Form is one page; promise string is enforced UI copy (`needs/detail.html:60`, echoed at post time per `docs/demo-walkthrough.md` §4) |
...
| 7 | Match → the connect | 63–78 | And when both say yes, there it is. Contact, shared between the two of you alone. The page says it better than I can: reach out kindly and arrange the rest together. From here it's two neighbors and a phone call. | `matches/detail.html:27` "shared between the two of you alone"; `_contact_info_box.html` "Reach out kindly and arrange the rest together." |
