...
- **In-flight (`feature/demo-polish`, 2026-07-14):** Father Mac demo pass. M1 ✅ seed (gate 858) · M2 ✅ inventory: 38 screens×2 widths, triage in docs/demo-triage-2026-07-14.md (SEV-1: no 403.html, DEBUG-404 in demo, consent legalese). Next: copy batch → visual batch → states batch → gallery. STOP at gallery for his key.
