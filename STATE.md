...
- **In-flight (`feature/demo-polish`, 2026-07-14):** Father Mac demo pass. M1 ✅ seed_demo_parish (fictional St. Brigid's: 12 members, 7 needs, 6 offers, proposed/accepted/fulfilled matches, verified deacon; DEBUG-only, idempotent, 3 tests). Next: screen inventory → copy/visual/states batches → walkthrough gallery. STOP at gallery for his key.
