...
- **In-flight (`feature/demo-polish`, 2026-07-14):** Father Mac demo pass. M1 ✅ seed (gate 858) · M2 ✅ inventory (triage doc) · M3 ✅ copy batch: 25 app em-dashes rewritten spoken, Title-Case cluster to sentence case, consent/account/dashboard de-jargoned, hub greets by first name. Next: visual batch (settings swatches) → states batch (403.html, DEBUG override, warm empties) → gallery. STOP at gallery for his key.
