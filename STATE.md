...
- **In-flight (`feature/demo-polish`, 2026-07-14):** Father Mac demo pass. M1 ✅ seed (gate 858) · M2 ✅ inventory (triage doc) · M3 ✅ copy batch: 25 app em-dashes rewritten spoken, Title-Case cluster to sentence case, consent/account/dashboard de-jargoned, hub greets by first name. M4 ✅ visual · M5 ✅ states · M6 ✅ copy pass 2 (47 literal dashes) · M7 ✅ gallery: docs/demo-walkthrough.md + 8 golden-path webps. Final gate pending, then HIS KEY (gallery review) before merge.
