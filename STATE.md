...
- **In-flight (`design/print-polish`, 2026-07-14):** M2 ✅ CLAUDE.md rules (CWD/TDD/quotes/Tailwind/PR-checklist). Next: M3 crop print paper-margins, M4 widow scene redo (his key: grieving figure).
