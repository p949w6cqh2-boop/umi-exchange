...
- **In-flight (`design/print-polish`, 2026-07-14):** M2 ✅ CLAUDE.md rules · M3 ✅ prints cropped to frame (webps regenerated, per-scene dims, plates p-2). Next: M4 widow scene redo (his key: grieving figure).
