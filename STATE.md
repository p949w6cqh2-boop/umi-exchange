...
- **In-flight (`feature/demo-polish`, 2026-07-14):** Father Mac demo pass. M1 ✅ seed (gate 858) · M2 ✅ inventory (triage doc) · M3 ✅ copy batch: 25 app em-dashes rewritten spoken, Title-Case cluster to sentence case, consent/account/dashboard de-jargoned, hub greets by first name. M4 ✅ visual (swatch defaults) · M5 ✅ states (warm 403.html, human 500 line, DEBUG env toggle so the demo runs with real error pages). Next: combined gate + golden-path gallery. STOP at gallery for his key.
